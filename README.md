...
![元素附魔](docs/element-skins.png)

机体造型、名字、射程都跟着**本体**走。元素是**材质**不是挂件——
它不会像普通副能力那样在机体旁边浮一个圆徽章，也不会挂零件上去，
而是直接长在机体上：黑曜石是染黑的机身 + 棱角分明的晶体 + 一点没冷透的熔芯，
霜雷是顶面结霜挂冰棱，腐蚀是酸液顺着外壳往下淌，奇点则是裹住整台机器的塌缩场。
（普通副能力照旧挂徽章，所以「黑曜石护盾装甲路障」上只有护盾那一个徽章。）
